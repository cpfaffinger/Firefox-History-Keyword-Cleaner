...
- Jeder erfolgreiche Commit auf `main` erzeugt ein geprüftes, unsigniertes ZIP
  als GitHub-Actions-Artefakt mit 90 Tagen Aufbewahrung.
- Ein Tag wie `v0.1.0` erzeugt zusätzlich ein dauerhaftes GitHub Release und
  hängt dasselbe geprüfte ZIP als Download-Asset an.
